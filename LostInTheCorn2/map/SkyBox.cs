...
namespace Skyboxes
{
    ...
    public class Skybox
    {
        ...
        public Skybox()
        {
            skyBoxEffect = Functional.ContentManager.Load<Effect>(@"LightboxEffect");
            skyBox = Functional.ContentManager.Load<Model>(@"LightBox");
            skyBoxTexture = Functional.ContentManager.Load<TextureCube>(@"TextureLightbox");
        }
